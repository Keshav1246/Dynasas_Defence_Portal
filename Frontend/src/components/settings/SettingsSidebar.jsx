...
const SettingsSidebar = ({ activeTab, onTabChange }) => {
  return (
    <div className="w-full lg:w-[220px] shrink-0 flex flex-col justify-between min-h-[500px] gap-8">
      <div>
        <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3 px-1">CONFIGURATION</h3>
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all text-[13px] font-semibold ${
                  isActive
      ...
      <div className="bg-[#111318] rounded-2xl p-5 shadow-lg text-white">
